...
(function() {
    ...
    d.AmChart = d.Class({
        ...
        drawChart: function() {
            0 < this.realWidth && 0 < this.realHeight && (this.drawBackground(), this.redrawLabels(), this.drawTitles(), this.renderFix(), this.chartDiv && (this.boundingRect = this.chartDiv.getBoundingClientRect()))
        },
        ...
        afterWrite: function(a) {
            if (a = "object" != typeof a ? document.getElementById(a) : a) {
                ...
                if (e) {
                    ...
                    if (e.enabled) switch (f.left = null, f.top = null, f.right = null, g.left = null, g.right = null, g.top = null, f.position = "relative", g.position = "relative", e.position) {
                        case "bottom":
                            k.appendChild(b);
                            k.appendChild(c);
                            break;
        ...
        measure: function() {
            ...
            if (a) {
                ...
                var g = d.removePx(d.getStyle(a, "padding-left")),
                    h = d.removePx(d.getStyle(a, "padding-right")),
                ...
                g = a.style;
                a = g.width;
                g = g.height; - 1 != a.indexOf("px") && (c = d.removePx(a)); - 1 != g.indexOf("px") && (e = d.removePx(g));
                e = Math.round(e);
                c = Math.round(c);
            ...
            if (this.animations)
                for (a = this.animations.length - 1; 0 <= a; a--) {
                    ...
                    if (e <= c) {
                        ...
                        b.suffix, f.animationFinished = !0, this.animations.splice(a, 1)
                }
        },
        update: function() {
        ...
        draw: function() {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    var w = this.minWidth,
                        z = "";
                    isNaN(w) || (z = "min-width:" + (w - 2 * p) + "px; ");
                    n.innerHTML = '<div style="text-align:' + this.textAlign + "; " + z + "max-width:" + this.maxWidth + "px; font-size:" + B + "px; color:" + this.color + "; font-family:" +
                        v + '">' + this.text + "</div>";
                    ...
                    "H" != u ? (w = a - z / 2, b < k + v + 10 && "down" != u ? (H = !0, e && (b += B), B = b + x, this.deltaSignY = -1) : (e && (b -= B), B = b - v - x, this.deltaSignY = 1)) : (2 * x > v && (x = v / 2), B = b - v / 2, a < h + (l - h) / 2 ? (w = a + x, this.deltaSignX = -1) : (w = a - z - x, this.deltaSignX = 1));
                    B + v >= m && (B = m - v);
                    B < k && (B = k);
                    w < h && (w = h);
                    w + z > l && (w = l - z);
                    ...
                    this.drop ? (h = z / 1.6, l = 0, "V" == u && (u = "down"), "H" == u && (u = "left"), "down" == u && (w = a + 1, B = b - h - h / 3), "up" == u && (l = 180, w = a + 1, B = b + h + h / 3), "left" == u && (l = 270, w = a + h + h / 3 + 2, B = b), "right" == u && (l = 90, w = a - h - h / 3 + 2, B = b), k = B - E / 2 + 1, m = w - F / 2 - 1, q = d.drop(f, h, l, q, y, p, t, L)) : 0 < A || 0 === x ? (0 < G && (a = d.rect(f, z, v, q, 0, p + 1, D, G, A), d.isModern ? a.translate(1, 1) : a.translate(4, 4), g.push(a)), q = d.rect(f, z, v, q, y, p, t, L, A)) : (r = [], A = [], "H" != u ? (h = a - w, h > z - x && (h = z - x), h < x && (h = x), r = [0, h - x, a - w, h + x, z, z, 0, 0], A = H ? [0, 0, b - B, 0, 0, v, v, 0] : [v, v, b - B, v, v, 0, 0, v]) : (u = b - B, u > v - x && (u = v - x), u < x && (u = x), A = [0, u - x, b - B, u + x, v, v, 0, 0], r = a < h + (l - h) / 2 ? [0, 0, w < a ? 0 : a - w, 0, 0, z, z, 0] : [z, z, w + z > a ? z : a - w, z, z, 0, 0, z]), 0 < G && (a = d.polygon(f, r, A, q, 0, p, D, G), a.translate(1, 1), g.push(a)), q = d.polygon(f, r, A, q, y, p, t, L));
                    this.bg = q;
                    g.push(q);
                    q.toFront();
                    ...
                    C.left = m + "px";
                    C.top = k + "px";
                    g.translate(w - f, B, 1, !0);
                    q = q.getBBox();
                    this.bottom = B + v + 1;
                    this.yPos = q.y + B;
                    J && J.translate(this.pointToX - w + f, b - B);
...
(function() {
    ...
    d.rect = function(a, b, c, e, f, g, h, k, l, m, n) {
        ...
        void 0 !== n && 0 < n && (f["stroke-dasharray"] = n);
        a = a.rect(r, p, b, c, l, g).attr(f);
        t && a.gradient("linearGradient", e, m);
        return a
    };
    d.bullet = function(a, b, c, e, f, g, h, k, l, m, n, q, t) {
        var r;
        "circle" == b && (b = "round");
        switch (b) {
            case "round":
    ...
    d.makeHD = function(a, b, c) {
        for (var e = [], d = [], g = 1; g < a.length; g++)
            for (var h = Number(a[g - 1]), k = Number(b[g - 1]), l = Number(a[g]), m = Number(b[g]), n = Math.round(Math.sqrt(Math.pow(l - h, 2) + Math.pow(m - k, 2)) / 50) + 1, l = (l - h) / n, m = (m - k) / n, q = 0; q <= n; q++) {
    ...
    d.handDrawnLine = function(a, b, c, e, f, g, h, k, l, m) {
        ...
        for (n = 1; n < b.length; n++)
            for (var t = [b[n - 1], b[n]], r = [c[n - 1], c[n]], r = d.makeHD(t, r, a.handDrawScatter), t = r[0], r = r[1], p = 1; p < t.length; p++) q.push(d.line(a, [t[p - 1], t[p]], [r[p - 1], r[p]], e, f, g + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, h, k, l, m, !0));
        return q
    };
    d.doNothing =
        function(a) {
    ...
    d.drop = function(a, b, c, e, d, g, h, k) {
        ...
        b = "M" + n + "," + q + " A" + b + "," + b + ",0,1,1," + t + "," + r + (" A" + p + "," + p + ",0,0,0," + (Math.sin((m + 20) * l) * b + x) + "," + (Math.cos((m + 20) * l) * b + y));
        b += " A" + p + "," + p + ",0,0,0," + n + "," + q;
        return a.path(b, void 0, void 0, "1000,1000").attr(c)
    };
    d.wedge = function(a, b, c, e, f, g, h, k, l, m, n, q, t, r) {
        var p = Math.round;
        g = p(g);
        h = p(h);
        k = p(k);
        ...
        var A = 1 / 180 * Math.PI,
            ...
            B = b + Math.sin(e * A) * g,
            C = c - Math.cos(e * A) * h,
            w = b + Math.sin((e + f) * A) * g,
            z = c - Math.cos((e + f) * A) * h,
            F = b + Math.sin((e + f) * A) * k,
            A = c - Math.cos((e + f) * A) * y,
            E = {
        ...
        e = a.set();
        var G;
        x && (u = p(10 * u), B = p(10 * B), w = p(10 * w), F = p(10 * F), v = p(10 * v), C = p(10 * C), z = p(10 * z), A = p(10 * A), b = p(10 * b), l = p(10 * l), c = p(10 * c), g *= 10, h *= 10, k *= 10, y *= 10, 1 > Math.abs(f) && 1 >= Math.abs(w - B) && 1 >= Math.abs(z - C) && (G = !0));
        f = "";
        var D;
        q && (E["fill-opacity"] = 0, E["stroke-opacity"] = m["stroke-opacity"] / 2, E.stroke = m.stroke);
        if (0 < l) {
            D = " M" + u + "," + (v + l) + " L" + B + "," + (C + l);
            x ? (G || (D += " A" + (b - g) + "," + (l + c - h) + "," + (b + g) + "," + (l + c + h) + "," + B + "," + (C + l) + "," + w + "," + (z + l)), D += " L" + F + "," + (A + l), 0 < k && (G || (D += " B" + (b - k) + "," + (l + c - y) + "," + (b + k) + "," +
                (l + c + y) + "," + F + "," + (l + A) + "," + u + "," + (l + v)))) : (D += " A" + g + "," + h + ",0," + H + ",1," + w + "," + (z + l) + " L" + F + "," + (A + l), 0 < k && (D += " A" + k + "," + y + ",0," + H + ",0," + u + "," + (v + l)));
            D += " Z";
            var K = l;
            x && (K /= 10);
            ...
            D = a.path(" M" + u + "," + v + " L" + u + "," + (v + l) + " L" + B + "," + (C + l) + " L" + B + "," + C + " L" + u + "," + v + " Z", void 0, void 0, "1000,1000").attr(E);
            l = a.path(" M" + w + "," + z + " L" + w + "," + (z + l) + " L" + F + "," + (A + l) + " L" + F + "," + A + " L" + w + "," + z + " Z", void 0, void 0, "1000,1000").attr(E);
            e.push(D);
            e.push(l)
        }
        x ? (G || (f = " A" + p(b - g) + "," + p(c - h) + "," + p(b + g) + "," + p(c + h) + "," + p(B) + "," + p(C) + "," + p(w) + "," + p(z)), h = " M" + p(u) + "," + p(v) + " L" + p(B) + "," + p(C) + f + " L" + p(F) + "," + p(A)) : h = " M" + u + "," + v + " L" + B + "," + C + (" A" + g + "," + h + ",0," + H + ",1," + w + "," + z) + " L" + F + "," + A;
        0 < k && (x ? G || (h += " B" + (b - k) + "," + (c - y) + "," + (b + k) + "," + (c + y) + "," + F + "," + A + "," + u + "," + v) : h += " A" + k + "," + y + ",0," + H + ",0," + u + "," + v);
        a.handDrawn && (k = d.line(a, [u, B], [v, C], m.stroke, m.thickness * Math.random() * a.handDrawThickness, m["stroke-opacity"]), e.push(k));
    ...
    d.AmLegend = d.Class({
        ...
        arrangeEntries: function() {
            ...
            for (v = 0; v < u.length; v++) {
                ...
                A = F.getBBox();
                var E;
                this.equalWidths ? E = B * (t +
                    n + this.markerLabelGap) : (E = C, C = C + A.width + g + n);
                A.height > z && (z = A.height);
                E + A.width > q && 0 < v && 0 !== B && (r++, E = B = 0, C = E + A.width + g + n, w = w + z + m, z = 0);
                F.translate(E, w);
                B++;
                !isNaN(l) && B >= l && (B = 0, r++, w = w + z + m, C = g, z = 0);
                x.push(F)
            }
            A = x.getBBox();
            l = A.height + 2 * m - 1;
            "left" == a || "right" == a ? (n = A.width + 2 * g, k = n + b + c, h.style.width = k + "px", this.ieW = k) : n = k - b - c - 1;
            ...
            c.toBack();
            b = g;
            if ("top" == a || "bottom" == a || "absolute" == a || "outside" == a) "center" == this.align ? b = g + (n - A.width) / 2 : "right" == this.align && (b = g + n - A.width);
            x.translate(b, m + 1);
        ...
        createEntry: function(a) {
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (b.useGraphSettings) {
                    e = a.type;
                    b.switchType = void 0;
                    if ("line" == e || "step" == e || "smoothedLine" == e || "ohlc" == e) k = m.set(), a.hidden || (f = a.lineColorR, h = a.bulletBorderColorR), q = d.line(m, [0, 2 * n], [n / 2, n / 2], f, a.lineAlpha, a.lineThickness, a.dashLength), d.setCN(c, q, "graph-stroke"), k.push(q), a.bullet && (a.hidden || (f = a.bulletColorR), q = d.bullet(m, a.bullet, a.bulletSize, f, a.bulletAlpha, a.bulletBorderThickness, h, a.bulletBorderAlpha)) && (d.setCN(c, q, "graph-bullet"), q.translate(n + 1, n / 2), k.push(q)), r = 0, q = n, t = n / 3;
                    else {
                        var p;
                        a.getGradRotation && (p = a.getGradRotation(), 0 === p && (p = 180));
                        q = a.fillColorsR;
                        !0 === a.hidden && (q = f);
                        if (k = b.createMarker("rectangle", q, a.fillAlphas, a.lineThickness, f, a.lineAlpha, p, k, a.dashLength)) r = n, k.translate(r, n / 2);
                        q = n
                    }
                    d.setCN(c, k, "graph-" + e);
                    ...
                    (k = b.createMarker(e, f, g, void 0, void 0, void 0, y, k)) && k.translate(n / 2, n / 2)
                }
                ...
                h = b.switchType;
                var x;
                h && "none" != h && 0 < n && ("x" == h ? (x = b.createX(), x.translate(n / 2, n / 2)) : x = b.createV(), x.dItem = a, !0 !== a.hidden ? "x" == h ? x.hide() : x.show() : "x" != h && x.hide(), b.switchable || x.hide(), b.addListeners(x, a), a.legendSwitch = x, m.push(x), d.setCN(c, x, "legend-switch"));
                h = b.color;
                a.showBalloon && b.textClickEnabled && void 0 !== b.selectedColor && (h = b.selectedColor);
                b.useMarkerColorForLabels && (h = f);
                ...
                c.accessible && b.accessibleLabel && (p = d.massReplace(b.accessibleLabel, {
                    "[[title]]": a.title
                }), c.makeAccessible(m, p));
                p = b.fontSize;
                k && (n <= p && (n = n / 2 + b.ly - p / 2 + (p + 2 - n) / 2 - t, k.translate(r, n), x && x.translate(x.x, n)), a.legendEntryWidth = k.getBBox().width);
                var u;
                f && (f = d.fixBrakes(f), a.legendTextReal = f, u = b.labelWidth, u = isNaN(u) ? d.text(b.container, f, h, c.fontFamily, p, "start") : d.wrappedText(b.container, f, h, c.fontFamily, p, "start", !1, u, 0), d.setCN(c, u, "legend-label"), u.translate(b.lx + q, b.ly), m.push(u), c = u.getBBox().width, b.maxLabelWidth <
                    c && (b.maxLabelWidth = c));
                b.entries[b.index] = m;
...
(function() {
    ...
    d.AmMap = d.Class({
                ...
                if (a = b.mapContainer) {
                    ...
                    if (!isNaN(k)) {
                        ...
                        var r = Math.sqrt(Math.pow(k - f, 2) + Math.pow(l - g, 2)),
                            p = b.initialDistance;
                        isNaN(p) && (p = Math.sqrt(Math.pow(k - f, 2) + Math.pow(l - g, 2)));
                        if (!isNaN(p)) {
                            var k = b.initialTouchZoom * r / p,
                                ...
                                r = m / t,
                                y = n / q,
                                p = (b.zoomX() - p * y) * (k / h) + p * y,
                                l = (b.zoomY() - l * r) * (k / h) + l * r;
                            .1 < Math.abs(k - h) && (b.zoomTo(k, p, l, !0), b.mapWasPinched = !0, clearTimeout(b.pinchTO))
                        }
                    }
                    k = a.scale;
                    b.isDragging && (b.balloon.hide(0), b.positionChanged(), c = a.x + (f - c), e = a.y + (g - e), b.preventDragOut && (t = -t * k + m / 2, m /= 2, c = d.fitToBounds(c, -q * k + n / 2, n / 2), e = d.fitToBounds(e, t, m)), isNaN(c) || isNaN(e) || (a.translate(c, e, k, !0), b.updateSmallMap()));
                    b.previuosMouseX = f;
                    b.previuosMouseY = g
                }
            }
        ...
        selectObject: function(a, b) {
            ...
            if (e) {
                if (d.removeCN(c, e, "selected-object"), d.setCN(c, e, "selected-object"), a.bringForwardOnHover && a.displayObject.toFront(), !a.preserveOriginalAttributes) {
                    ...
                    if ("MapLine" == a.objectType) {
                        var l = a.lineSvg;
                        l && l.setAttr("stroke", g);
                        if (l = a.arrowSvg) l.setAttr("fill", g), l.setAttr("stroke", g)
                    }
                    if (l = a.imageLabel) {
        ...
        processObjects: function() {
            ...
            if (0 < a.images.length || 0 < a.areas.length || 0 < a.lines.length || a == this.dataProvider) {
                ...
                g && g.remove();
                this.mapLinesContainer = g = b.set();
    ...
    d.ZoomControl = d.Class({
        ...
        init: function(a, b) {
            ...
            var f = c.buttonSize,
                ...
                w = a.getX(c.left),
                z = a.getY(c.top);
            isNaN(c.right) || (w = a.getX(c.right, !0), w = h ? w - 3 * f : w - f);
            ...
            if (g) {
                ...
                c.set = e;
                c.zoomSet = F;
                5 < p && (g = d.rect(b, f + 6, p + 2 * f + 6, c.gridBackgroundColor, c.gridBackgroundAlpha, 0, 0, 0, 4), d.setCN(a, g, "zoom-bg"), g.translate(-3, -3), g.mouseup(function() {
                    c.handleBgUp()
                }).touchend(function() {
                    c.handleBgUp()
                }), F.push(g));
                ...
                B && (E = f / 1.5);
                c.draggerSize = E;
                var H = Math.log(u / x) / Math.log(y) + 1;
                1E3 < H && (H = 1E3);
                var g = p / H,
                    G, D = b.set();
                ...
                c.previousY = NaN;
                z = new d.SimpleButton;
                C ? (E = b.set(), H = d.line(b, [-w, w], [0, 0], v, A, 1), G = d.line(b, [0, 0], [-w, w], v, A, 1), E.push(H), E.push(G), z.svgIcon = E) : z.setIcon(a.pathToImages + "plus.gif", c.iconSize);
                z.setClickHandler(a.zoomIn, a);
                z.init(b, f, f, k, l, m, n, q, t, r, A, v, B);
                d.setCN(a, z.set, "zoom-in");
                F.push(z.set);
                z = new d.SimpleButton;
                C ? z.svgIcon = d.line(b, [-w, w], [0, 0], v, A, 1) : z.setIcon(a.pathToImages + "minus.gif", c.iconSize);
...
(function() {
    ...
    d.SimpleButton = d.Class({
        construct: function() {},
        init: function(a, b, c, e, f, g, h, k, l, m, n, q, t) {
            var r = this;
            r.rollOverColor = m;
            r.color = e;
            r.container = a;
            ...
            f = r.iconPath;
            var p;
            f && (p = r.iconSize, g = (b - p) / 2, t && (g = (2 * b - p) / 2), p = a.image(f, g, (c - p) / 2, p, p));
...
(function() {
    ...
    d.SmallMap = d.Class({
        ...
        handleMouseUp: function() {
            var a = this.chart,
                b = a.zoomLevel();
            a.zoomToStageXY(b, (a.mouseX - this.set.x) / this.size, (a.mouseY - this.set.y) / this.size)
        }
    })
})();
(function() {
    ...
    d.AreasProcessor = d.Class({
        ...
        process: function(a) {
            ...
            b.minValueReal = k;
            for (d = 0; d < c; d++) f = a[d],
                isNaN(f.value) ? f.percents = void 0 : (f.percents = (f.value - k) / g * 100, k == h && (f.percents = 100));
        ...
        createArea: function(a) {
            ...
            isNaN(e.selectedBrightness) || (x = d.adjustLuminosity(a.colorReal, e.selectedBrightness / 100));
            a.alphaReal = B;
            a.rollOverColorReal = n;
            a.rollOverAlphaReal = h;
            a.balloonTextReal = m;
            a.selectedColorReal = x;
            ...
            if (c && (q = c.area, A = c.title, a.enTitle = c.title, A && !a.title && (a.title = A), (c = b.language) ? (A = d.mapTranslations) && (c = A[c]) && c[a.enTitle] && (a.titleTr = c[a.enTitle]) : a.titleTr = void 0, q)) {
                c = a.tabIndex;
                ...
                a.preserveOriginalAttributes || (q.setAttr("fill", C), q.setAttr("stroke", g), q.setAttr("stroke-opacity", t), q.setAttr("stroke-width", r), q.setAttr("fill-opacity",
                    B));
...
(function() {
    ...
    d.ImagesProcessor = d.Class({
        ...
        createImage: function(a, b) {
            ...
            u = a.rollOverBrightness;
            void 0 == u && (u = F);
            void 0 == a.selectable && (a.selectable = A);
            a.colorReal = G;
            ...
            if (F) {
                ...
                if ("circle" == F || "bubble" == F) E = C;
                D = this.createPredefinedImage(G, t, r, F, C, E);
                p = A = 0;
                a.centeredReal ? (isNaN(a.right) || (A = C * n), isNaN(a.bottom) || (p = E * n)) : (A = C * n / 2, p = E * n / 2);
                D.translate(A, p, n, !0)
        ...
        updateSizeAndPosition: function(a) {
            ...
            a.line && a.line.getCoordinates && (a.line.chart = b, p = a.line.getCoordinates(m, a.lineSegment)) && (k = b.coordinateToLongitude(p.x), l = b.coordinateToLatitude(p.y), t = p.x, r = p.y, a.animateAngle && (g = d.radiansToDegrees(p.angle)));
            isNaN(g) || c.rotate(g + a.extraAngle);
            if (!isNaN(e) && !isNaN(f)) c.translate(e, f, NaN, !0);
            else if (!isNaN(l) && !isNaN(k))
                if (f = b.coordinatesToXY(k, l), e = f.x, f = f.y, isNaN(t) || (e = t), isNaN(r) || (f = r), a.fixedSize) {
                    t = 1;
                    if (a.showAsSelected || b.selectedObject == a) t = a.selectedScaleReal;
                    b = a.positionScale;
                    ...
                    c.translate(e, f, t / q + b, !0)
                } else c.translate(e, f, NaN, !0), n && (this.labelsToReposition.push(a), a.arrays.push({
        ...
        positionLabel: function(a, b, c) {
            if (a) {
                var d = b.image,
                    ...
                    h = 0,
                    k = 0;
                d && (k = d.getBBox(), g = d.y, f = d.x, h = k.width, k = k.height, b.svgPath && (h *= b.scale, k *= b.scale));
                var d = a.getBBox(),
                    l = d.width,
                    m = d.height;
                ...
                b.labelBG && b.labelBG.translate(f - d.width / 2 + b.labelShiftX - 9, g + b.labelShiftY - d.height / 2 - 3, NaN, !0)
            }
        },
    ...
    d.LinesProcessor = d.Class({
        ...
        createLine: function(a, b) {
            ...
            if (a.remainVisible || c.selectedObject == a.parentObject) {
                ...
                p = n.length;
                if (0 < p)
                    for (v = [], C = [], u = 0; u < p; u++) x = c.coordinatesToXY(n[u], e[u]), v.push(x.x), C.push(x.y);
                if (0 < v.length) {
                    a.segments = v.length;
                    d.dx = 0;
                    d.dy = 0;
                    var E, H, G, p = 10 * (1 - Math.abs(A));
                    10 <= p && (p = NaN);
                    1 > p && (p = 1);
                    a.arcRadius = [];
                    a.distances = [];
                    ...
                    if (isNaN(p)) {
                        ...
                        void 0 !== k && 0 < k && (x["stroke-dasharray"] = k);
                    ...
                    if ("none" != B) {
                        var I, M, N;
                        if ("end" == B || "both" == B) u = v[v.length - 1], D = C[C.length - 1], 1 < v.length ?
                            (x = v[v.length - 2], I = C[C.length - 2]) : (x = u, I = D), I = 180 * Math.atan((D - I) / (u - x)) / Math.PI, isNaN(E) || (I += E), M = u, N = D, I = 0 > u - x ? I - 90 : I + 90;
                        r = [-t / 2 - .5, -.5, t / 2 - .5];
                        k = [t, -.5, t];
                        a.shiftArrow && "middle" != B && (k = [0, 1.2 * -t, 0]);
                        "both" == B && (t = d.polygon(w, r, k, m, q, 1, m, q, void 0, !0), z.push(t), t.translate(M, N, 1 / n, !0), isNaN(I) || t.rotate(I), d.setCN(c, p, "map-line-arrow"), void 0 != a.id && d.setCN(c, p, "map-line-arrow-" + a.id), a.fixedSize && f.push(t));
                        if ("start" == B || "both" == B) t = v[0], N = C[0], 1 < v.length ? (u = v[1], M = C[1]) : (u = t, M = N), I = 180 * Math.atan((N -
                            M) / (t - u)) / Math.PI, isNaN(E) || (I -= E), M = t, I = 0 > t - u ? I - 90 : I + 90;
                        "middle" == B && (u = v[v.length - 1], D = C[C.length - 1], 1 < v.length ? (x = v[v.length - 2], I = C[C.length - 2]) : (x = u, I = D), M = x + (u - x) / 2, N = I + (D - I) / 2, I = 180 * Math.atan((D - I) / (u - x)) / Math.PI, isNaN(E) || (E = H / 2, G -= Math.sqrt(G * G - E * E), 0 > A && (G = -G), E = Math.sin(I / 180 * Math.PI), -1 == E && (E = 1), M -= E * G, N += Math.cos(I / 180 * Math.PI) * G), I = 0 > u - x ? I - 90 : I + 90);
...
(function() {
    ...
    d.normalizePath = function(a) {
        for (var b = "", c = d.parsePath(a.getAttribute("d")), e, f, g = Infinity, h = -Infinity, k = Infinity, l = -Infinity, m = 0; m < c.length; m++) {
            ...
            "v" == q && (q = "L", t = e, n += f);
            "V" == q && (q = "L", t = e);
            if ("m" === q || "l" === q) q = q.toUpperCase(), t += e, n += f;
            t = d.roundTo(t, 3);
            n = d.roundTo(n, 3);
            e = t;
            f = n;
    ...
    d.winkel3.invert = function(a, b) {
        ...
        do var h = Math.cos(e),
            ...
            p = r * r,
            y = 1 - n * t * t,
            x = y ? d.acos(h * t) * Math.sqrt(u = 1 / y) : u = 0,
            u, y = .5 * (2 * x * h * r + c / g) - a,
            A = .5 * (x * k + e) - b,
            v = .5 * u * (n * p + x * h * t * m) + .5 / g,
            B = u * (q * l / 4 - x * k * r),
            k = .125 * u * (l * r - x * k * n * q),
            m = .5 * u * (m * t + x * p * h) + .5,
            h = B * k - m * v,
            ...
            y = (y * k - A * v) / h,
            c = c - B,
            e = e - y; while ((1E-6 < Math.abs(B) || 1E-6 < Math.abs(y)) && 0 < --f);
        return [c, e]
    };
